...
from pages.BICL.tools.wedbush_research.wedbush_research import wedbush_research
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        # Click Wedbush Research
        t.click_wedbush_research()

        time.sleep(10)

        wr = wedbush_research(driver)
        ...
        wr.validate_hamburger_menu_clickable(test_case_ID, browser, env, time_stamp)
