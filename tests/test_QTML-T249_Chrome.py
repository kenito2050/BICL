...
from pages.BICL.gain_loss.holdings.unrealized_summary.unrealized_summary import unrealized_summary
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        unrs = unrealized_summary(driver)

        # Click on PDF Button
        unrs.click_PDF_Button()
