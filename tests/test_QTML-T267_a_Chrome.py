...
from pages.BICL.notes_modal.all_rep_notes_tab.all_rep_notes_tab import all_rep_notes_tab
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        # click "All Rep Notes"
        nm.click_all_rep_notes_tab()

        time.sleep(1)

        # Click PDF Export Button

        arnt = all_rep_notes_tab(driver)

        arnt.click_export_pdf_button()
