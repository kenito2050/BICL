...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        d.verify_text_exists_in_Today_Column(test_case_ID, browser, env, time_stamp)

        time.sleep(15)

        d.verify_text_exists_in_AS_OF_Column(test_case_ID, browser, env, time_stamp)
