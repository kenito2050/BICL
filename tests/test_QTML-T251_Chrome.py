...
from pages.BICL.gain_loss.holdings.realized.realized import realized
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        real = realized(driver)

        time.sleep(5)

        # Click on PDF Button
        real.click_PDF_Button()
