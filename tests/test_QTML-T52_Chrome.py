...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        # Select 401B Letters
        # This section is a work-around to select 401B Letters
        ...
        # 401B Letters Should Display

        time.sleep(5)

        # Input Date
        doc.input_date(valid_date)
