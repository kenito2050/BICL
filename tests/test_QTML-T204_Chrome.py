...
from pages.BICL.account_search_modal.security_description_results.security_description_results import security_description_results
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        sdr = security_description_results(driver)

        sdr.verify_text_displays(test_data2, test_case_ID, browser, env, time_stamp)
