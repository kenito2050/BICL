...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        # Change Office Code to KS
        adm.update_office_code_new(rep_code)
        ...
        # Confirm that Firelight Not Present
        tls.confirm_firelight_not_present(test_case_ID, browser, env, time_stamp)
