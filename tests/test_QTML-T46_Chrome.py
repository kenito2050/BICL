...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        # Navigate to Account Info Panel using URL String
        ...
        # Select 401B Letters
        ddd.select_401B_letters()

        time.sleep(30)

        # Take screenshot after clicking TAX STATEMENTS and save to utilities/test_results/screenshots
        ...
        # Commented out This section as it is causing a "False Fail"
