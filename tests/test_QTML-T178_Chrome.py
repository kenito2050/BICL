...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        screen_to_navigate_to_1 = "account_positions"
        ...
        ap.verify_values_display_in_Change_Column(test_case_ID, browser, env, time_stamp)
