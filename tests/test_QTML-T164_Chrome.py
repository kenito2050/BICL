...
from pages.MYCL.tools.calculators.calculators import calculators
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        # Click Calculators
        tls.click_calculators()

        time.sleep(5)

        cal = calculators(driver)

        # Verify text "Financial Calculators" displays on Calculators screen
        cal.verify_text(test_data1, test_case_ID, browser, env, time_stamp)
