...
from pages.MYCL.tools.quotes_charts.quotes_charts import quotes_charts
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        qc = quotes_charts(driver)

        qc.click_options_lookup()
