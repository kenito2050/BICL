...
from pages.BICL.account.activity.activity import activity
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        # Confirm Data Formatting Issues Correct

        act = activity(driver)

        time.sleep(5)

        act.verify_data_formatting_correct(test_case_ID, browser, env, time_stamp)
