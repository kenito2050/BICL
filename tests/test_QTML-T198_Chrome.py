...
from pages.BICL.default_page.alerts.alerts import alerts
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        # Click PORTFOLIO Panel

        a.click_portfolio()

        # PORTFOLIO Panel Displays
