...
up.input_current_username(username)

# Enter New Username
up.enter_new_username(test_data1)

# Re Enter New Username
up.re_enter_new_username(test_data1)

# Enter Password
up.enter_password(password)

# Click Save Button
up.click_save_button()
...
# Navigate Back to Profile / Preferences - User Preferences Displays

lp.click_profile_preferences()

time.sleep(5)

# Confirm fields Not Pre-populated
