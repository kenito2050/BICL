...
from pages.BICL.housekeeping.shareholder_materials.shareholder_materials import shareholder_materials
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        # Verify Shareholder Materials does not display
        h.verify_shareholder_materials_not_display(test_case_ID, browser, env, time_stamp)
