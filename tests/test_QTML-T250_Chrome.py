...
from pages.BICL.gain_loss.holdings.holdings import holdings
from pages.BICL.gain_loss.holdings.unrealized_detail.unrealized_detail import unrealized_detail
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        # Select Unrealized Detail

        h.select_unrealized_detail()
        ...
        unde = unrealized_detail(driver)

        # Click on PDF Button
        unde.click_PDF_Button()
