...
from pages.BICL.account.overview.overview import overview
...
# Validate Decimals in NET MARKET VALUE Column
o.verify_decimals_in_net_market_value_total(test_case_ID, browser, env, time_stamp)

o.verify_decimals_in_funds_available_total(test_case_ID, browser, env, time_stamp)
