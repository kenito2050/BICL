...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        d.count_assert_number_rows_on_account_balances_table(test_case_ID, browser, env, time_stamp)

        d.count_assert_number_columns_on_account_balances_table(test_case_ID, browser, env, time_stamp)
