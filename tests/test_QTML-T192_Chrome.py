...
from pages.BICL.default_page.hamburger_menu.hamburger_menu import hamburger_menu
from pages.BICL.default_page.hamburger_menu.account.ira_summary.ira_summary import ira_summary_modal
from pages.BICL.default_page.hamburger_menu.account.distributions.distributions import distributions_modal
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        dp.verify_account_icon_clickable(test_case_ID, browser, env, time_stamp)
        ...
        # Click Account on Hamburger Menu
        hm.click_account()

        time.sleep(5)

        # Open IRA Summary Model
        hm.select_ira_summary()
        ...
        ism = ira_summary_modal(driver)

        time.sleep(2)

        # Close IRA Summary Modal
        ism.close_IRA_Summary_Modal()
        ...
        # Open Distributions Modal
        hm.select_distributions()
        ...
        dm = distributions_modal(driver)

        # Close Distributions Modal
        dm.click_close_button_distributions_modal()
        ...
        gp.take_screenshot(test_case_ID, browser, control_point_3, screenshot_number, env, time_stamp_4)
