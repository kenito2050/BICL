...
from pages.BICL.housekeeping.documents.monthly_statements.monthly_statements import monthly_statements
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        # Select GMAP Reports
        # Work Around to Select GMAP Reports
