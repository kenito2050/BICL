...
from pages.BICL.account.balances.balances import balances
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        # Validate data populates for Cash Flow Summary
        b.verify_values_display_in_Value_Equity_Summary(test_case_ID, browser, env, time_stamp)
