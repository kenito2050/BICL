...
from pages.BICL.notes_modal.account_notes_tab.account_notes_tab import account_notes_tab
...
class Test_login_Chrome:
    ...
    def test_login_chrome(self, browser, env):
        ...
        nm.click_account_notes_tab()

        time.sleep(3)

        # Click PDF Export Button

        acnt = account_notes_tab(driver)
